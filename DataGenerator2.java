...
public class DataGenerator2
{
				...
				switch (command.toUpperCase()) {
					...
					case "AV":
						if (tokens.length == 2) {
							...
							dataGenerator_testcase1_av(graph,num);
						}
						else {
					...
					case "AE":
						if (tokens.length == 2) {
							int num = Integer.parseInt(tokens[1]);
							dataGenerator_testcase2_ae(graph,num);
						}
						else {
							System.err.println(lineNum + ": incorrect number of tokens.");
						}
					...
					case "N":
						if (tokens.length == 2) {
							int num = Integer.parseInt(tokens[1]);
							dataGenerator_testcase5_n(graph,num);
						}
						else {
							System.err.println(lineNum + ": incorrect number of tokens.");
						}
					...
					case "RV":
						if (tokens.length == 2) {
							int num = Integer.parseInt(tokens[1]);
							dataGenerator_testcase3_rv(graph,num);
						}
						else {
							System.err.println(lineNum + ": incorrect number of tokens.");
						}
					...
					case "RE":
						if (tokens.length == 2) {
							int num = Integer.parseInt(tokens[1]);
							dataGenerator_testcase4_re(graph,num);
						}
						else {
							System.err.println(lineNum + ": incorrect number of tokens.");
						}
					...
					case "S":
						if (tokens.length == 2) {
							int num = Integer.parseInt(tokens[1]);
							dataGenerator_testcase6_s(graph,num);
						}
						else {
							System.err.println(lineNum + ": incorrect number of tokens.");
						}
	...
	public static void main(String[] args) {
		...
		if (remainArgs.size() == 5) {
			...
			System.out.println("Interative Test mode.");
			System.out.println("Test file name : facebook_combined.txt");
	...
	/***** for data generator  ********/
	private static final int FACEBOOK_VERTEX_NUM = 4038;
	/**
	 * test add vertex operation num times.
	 * @param num
	 */
	private static void dataGenerator_testcase1_av(FriendshipGraph<String> graph,int num){
		
		if(num > 0){
			Random r = new Random();
			long time = System.currentTimeMillis();
			for(int i = 0 ; i < num ; i ++){
				graph.addVertex("test_vertex"+i);
			}
	 ...
	 * @param num
	 */
	private static void dataGenerator_testcase2_ae(FriendshipGraph<String> graph,int num){
		
		if(num > 0){
			Random r = new Random();
			long time = System.currentTimeMillis();
			for(int i = 0 ; i < num ; i ++){
				String v1 = "" + r.nextInt(FACEBOOK_VERTEX_NUM);
				String v2 = "" + r.nextInt(FACEBOOK_VERTEX_NUM);
				graph.addEdge(v1, v2);
			}
			time = System.currentTimeMillis()-time;
			System.out.println("cost time : "+time + " ms");
	 ...
	 * @param num
	 */
	private static void dataGenerator_testcase3_rv(FriendshipGraph<String> graph,int num){
	 ...
	 * @param num
	 */
	private static void dataGenerator_testcase4_re(FriendshipGraph<String> graph,int num){
	 ...
	 * @param num
	 */
	private static void dataGenerator_testcase5_n(FriendshipGraph<String> graph,int num){
	 ...
	 * @param num
	 */
	private static void dataGenerator_testcase6_s(FriendshipGraph<String> graph,int num){
		...
		if(num > 0){
			...
			for(int i = 0 ; i < num ; i ++){
				String v1 = "" + r.nextInt(FACEBOOK_VERTEX_NUM);
				String v2 = "" + r.nextInt(FACEBOOK_VERTEX_NUM);
				graph.shortestPathDistance(v1, v2);
			}
			time = System.currentTimeMillis()-time;
			System.out.println("cost time : "+time + " ms");
